...
gsap.from(".logo-i", { opacity: 0, duration: 1, delay: 0.5, y: -10 });
gsap.from(".logo", { opacity: 0, duration: 1, delay: 0.5, y: -10 });
gsap.from(".hamburger", { opacity: 0, duration: 1, delay: 1, x: 20 });
gsap.from(".bag-icon", { opacity: 0, duration: 1, delay: 1, x: 20 });
gsap.from(".wishlist-icon", { opacity: 0, duration: 1, delay: 1, x: 20 });
